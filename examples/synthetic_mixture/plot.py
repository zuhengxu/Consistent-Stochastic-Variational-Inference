...
#########################################################
f1, axa1 = plt.subplots(1, 7, figsize=(20,2.8), sharey = 'row', sharex = 'col' )
...
zip_arg = zip(['CSVI', 'CSVI_RSD', 'CSL' ,'SVI', 'SVI_Ind','SVI_SMAP' ,'SVI_OPT'],
                ['#89bedc', 'turquoise', 'maroon'  ,'pink','orange', 'plum' ,'olive'],
                ['#0b559f', 'teal', 'indianred' ,'palevioletred','orangered', 'orchid','green'])
...
ax2 = sns.violinplot(x = 'method', y = 'elbo',data = df_results,
                    ...
                    order = ['CSVI', 'CSVI_RSD', 'CSL', 'SVI', 'SVI_Ind', 'SVI_SMAP', 'SVI_OPT'])
plt.xlabel('')
