...
df_results.replace('CSL', 'CLA', inplace=True)
df_results.replace('LAP', 'Laplace', inplace=True)

## color palette
col_pal = {"CSVI": '#89bedc', "SVI": 'pink',
            'CSVI_RSD': 'teal',  'SVI_Ind':'orange',
            'SVI_SMAP':'plum' ,'SVI_OPT':'olive', 
        'CLA': 'maroon', 'Laplace': 'maroon'}
...
#########################################################
f1, axa1 = plt.subplots(1, 8, figsize=(22,2.8), sharey = 'row', sharex = 'col' )
...
zip_arg = zip(['CSVI', 'CSVI_RSD', 'CLA', 'Laplace','SVI', 'SVI_Ind','SVI_SMAP' ,'SVI_OPT'],
                ['#89bedc', 'turquoise', 'maroon', 'maroon' ,'pink','orange', 'plum' ,'olive'],
                ['#0b559f', 'teal', 'indianred', 'indianred' ,'palevioletred','orangered', 'orchid','green'])
