...
###compare with SVI
#################
df0 = pd.read_csv('/home/zuheng/Research/Consistent-Stochastic-Variational-Inference/examples/sparse_regression/results/VI_results/SYN_SVI_adam_PriorRandom.csv') 
df1 = pd.read_csv('/home/zuheng/Research/Consistent-Stochastic-Variational-Inference/examples/sparse_regression/results/VI_results/SYN_RSVI_PriorRandom.csv')
...
ax = sns.violinplot(x = 'Regularization', y = 'ELBO',data = df_syn,
                    scale = 'count', inner = 'stick', bw = 0.03, linewidth=0.4, gridsize=1000 )
...
###optimal init 
#################
df3 = pd.read_csv('/home/zuheng/Research/Consistent-Stochastic-Variational-Inference/examples/sparse_regression/results/VI_results/SYN_SVI_adam_SMAP_adamInd.csv')
